...
Each Morphy release pins the exact commit SHA of every external weight source
...
To cut a new Morphy release that tracks updated upstream weights:
  ...
  4. Bump Morphy's version in morphy/__init__.py.
"""
...
# Morphy's own trained AG/med heads
MORPHY_WEIGHTS_REV = "d23dedbda2344bb94b6d0b8eb7c96a0d07692582"
